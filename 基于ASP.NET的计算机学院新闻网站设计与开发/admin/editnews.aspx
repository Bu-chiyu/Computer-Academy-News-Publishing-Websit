...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>发布信息</title>
    <link href="../css/style-editnews.css" rel="stylesheet" />
...
<body>
    ...
    <div id="box">
        <div id="title">新闻编辑</div>
        <div id="head">
            <div style="width:1000px;margin:10px auto;">
                <span>标题：</span><asp:TextBox ID="tbTitle" runat="server" AUTOCOMPLETE="OFF"></asp:TextBox>
            </div>
            <div style="width:1000px;margin:10px auto;">
                <span>主页图片：</span><asp:TextBox ID="tbImgUrl" runat="server" Width="450px" AUTOCOMPLETE="OFF"></asp:TextBox>
            </div>
            <div style="width:1000px;margin:10px auto;">
        ...
        <div style="width:1000px;margin:10px auto;">
            ...
            <br />
            <div id="divBtn">
                <asp:Button ID="btnEdit" runat="server" Text="提交内容" OnClick="btnEdit_Click" CssClass="btnCss"/>
